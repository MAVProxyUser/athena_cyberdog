...
namespace athena_led
{
class LedDetNode : public athena_utils::LifecycleNode
{
public:
  LedDetNode();
  ~LedDetNode();
...
: athena_utils::LifecycleNode("LedDetNode")
{
...
athena_utils::CallbackReturn LedDetNode::on_configure(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn LedDetNode::on_activate(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn LedDetNode::on_deactivate(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn LedDetNode::on_cleanup(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  return athena_utils::CallbackReturn::SUCCESS;
}

athena_utils::CallbackReturn LedDetNode::on_shutdown(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  return athena_utils::CallbackReturn::SUCCESS;
}
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<athena_led::LedDetNode>();
