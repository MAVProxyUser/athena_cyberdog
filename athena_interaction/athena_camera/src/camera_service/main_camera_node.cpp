...
athena_utils::CallbackReturn CameraServerNode::on_configure(const rclcpp_lifecycle::State &)
{
  ...
  m_faceManager = create_service<FaceManagerT>(
    "face_manager",
    std::bind(
      &athena_camera::FaceManagerNode::serviceCallback,
      std::make_shared<athena_camera::FaceManagerNode>(),
      std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
...
athena_utils::CallbackReturn CameraServerNode::on_activate(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn CameraServerNode::on_deactivate(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn CameraServerNode::on_cleanup(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn CameraServerNode::on_shutdown(const rclcpp_lifecycle::State &)
{
