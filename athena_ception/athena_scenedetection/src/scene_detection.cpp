...
{
class GpsPubNode : public athena_utils::LifecycleNode
{
public:
  GpsPubNode();
  ~GpsPubNode();
...
: athena_utils::LifecycleNode("GpsPubNode")
{
...
athena_utils::CallbackReturn GpsPubNode::on_configure(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn GpsPubNode::on_activate(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn GpsPubNode::on_deactivate(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn GpsPubNode::on_cleanup(const rclcpp_lifecycle::State &)
{
  publisher_.reset();
  return athena_utils::CallbackReturn::SUCCESS;
}

athena_utils::CallbackReturn GpsPubNode::on_shutdown(const rclcpp_lifecycle::State &)
{
  publisher_.reset();
  return athena_utils::CallbackReturn::SUCCESS;
}
