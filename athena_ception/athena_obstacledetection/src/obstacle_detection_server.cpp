...
{
class ObDetPubNode : public athena_utils::LifecycleNode
{
public:
  ObDetPubNode();
  ~ObDetPubNode();
...
: athena_utils::LifecycleNode("ObDetPubNode")
{
...
athena_utils::CallbackReturn ObDetPubNode::on_configure(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn ObDetPubNode::on_activate(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn ObDetPubNode::on_deactivate(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn ObDetPubNode::on_cleanup(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  publisher_.reset();
  return athena_utils::CallbackReturn::SUCCESS;
...
athena_utils::CallbackReturn ObDetPubNode::on_shutdown(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  publisher_.reset();
  return athena_utils::CallbackReturn::SUCCESS;
