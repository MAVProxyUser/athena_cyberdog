...
public:
  ...
  : Node("test")
  {
    bms_test_pub = this->create_publisher<athena_interfaces::msg::Bms>("buzze", 10);
...
private:
  rclcpp::Publisher<athena_interfaces::msg::Bms>::SharedPtr bms_test_pub;
  athena_interfaces::msg::Bms msg;
};
