...
{
class LightDetPubNode : public athena_utils::LifecycleNode
{
public:
  LightDetPubNode();
  ~LightDetPubNode();
...
: athena_utils::LifecycleNode("LightDetPubNode")
{
...
athena_utils::CallbackReturn LightDetPubNode::on_configure(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  ...
  sensor_obj = new athena_utils::athena_sensor(1);
...
athena_utils::CallbackReturn LightDetPubNode::on_activate(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn LightDetPubNode::on_deactivate(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
...
athena_utils::CallbackReturn LightDetPubNode::on_cleanup(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  publisher_.reset();
  return athena_utils::CallbackReturn::SUCCESS;
...
athena_utils::CallbackReturn LightDetPubNode::on_shutdown(const rclcpp_lifecycle::State & state)
{
  UNUSED_VAR(state);
  publisher_.reset();
  return athena_utils::CallbackReturn::SUCCESS;
