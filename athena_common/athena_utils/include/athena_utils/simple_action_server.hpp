...
#ifndef ATHENA_UTILS__SIMPLE_ACTION_SERVER_HPP_
#define ATHENA_UTILS__SIMPLE_ACTION_SERVER_HPP_
...
{
/**
* @class athena_utils::SimpleActionServer
...
#endif  // ATHENA_UTILS__SIMPLE_ACTION_SERVER_HPP_
