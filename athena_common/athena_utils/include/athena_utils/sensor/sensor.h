...
#ifndef ATHENA_UTILS__SENSOR__SENSOR_H_
#define ATHENA_UTILS__SENSOR__SENSOR_H_

#include "athena_utils/sensor/sensor_base.h"
...
#endif  // ATHENA_UTILS__SENSOR__SENSOR_H_
