...
#ifndef ATHENA_UTILS__SENSOR__SENSOR_UTILS_HPP_
#define ATHENA_UTILS__SENSOR__SENSOR_UTILS_HPP_
...
#include "athena_utils/sensor/sensor.h"
...
{
public:
  explicit athena_sensor(int sensor_count);
  ~athena_sensor();
...
#endif  // ATHENA_UTILS__SENSOR__SENSOR_UTILS_HPP_
