...
class TestNode : public athena_utils::LifecycleNode
{
public:
  explicit TestNode(
...
TEST(athena_utils, activations_managing_basic)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>("node_A");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>("node_B");
  auto node_c = std::make_shared<athena_utils::LifecycleNode>("node_C");
...
TEST(athena_utils, activations_managing_late_joining)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>("node_A");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>("node_B");
  ...
  auto node_b2 = std::make_shared<athena_utils::LifecycleNode>("node_B");
  auto node_c = std::make_shared<athena_utils::LifecycleNode>("node_C");
  executor.add_node(node_c->get_node_base_interface());
...
TEST(athena_utils, activations_chained)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>("node_A");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>("node_B");
...
TEST(athena_utils, multiple_activations_chained)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>("node_A");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>("node_B");
  auto node_c = std::make_shared<athena_utils::LifecycleNode>("node_C");
...
TEST(athena_utils, activators_disappearance)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>("node_A");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>("node_B");
...
TEST(athena_utils, activators_disappearance_inter)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>("node_A");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>("node_B");
  auto node_c = std::make_shared<athena_utils::LifecycleNode>("node_C");
...
TEST(athena_utils, activations_managing_basic_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
  auto node_b = std::make_shared<athena_utils::LifecycleNode>(
    "node_B",
    "test_ns");
  auto node_c = std::make_shared<athena_utils::LifecycleNode>(
    "node_C",
    "test_ns");
...
TEST(athena_utils, activations_managing_late_joining_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
  ...
  auto node_b2 = std::make_shared<athena_utils::LifecycleNode>(
    "node_B",
    "test_ns");
  auto node_c = std::make_shared<athena_utils::LifecycleNode>(
    "node_C",
...
TEST(athena_utils, activations_chained_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
...
TEST(athena_utils, multiple_activations_chained_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
...
TEST(athena_utils, fast_change_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
...
TEST(athena_utils, activators_disappearance_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
...
TEST(athena_utils, activators_disappearance_inter_with_namespace)
{
  auto node_a = std::make_shared<athena_utils::LifecycleNode>(
    "node_A",
    "test_ns");
...
TEST(athena_utils, inheritance_with_namespace)
{
