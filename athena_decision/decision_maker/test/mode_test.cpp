...
int main(int argc, char ** argv)
{
  ...
  auto node_cascade0 = std::make_shared<athena_utils::LifecycleNode>("interactive");
  auto node_cascade1 = std::make_shared<athena_utils::LifecycleNode>("rtabmap");
  auto node_cascade2 = std::make_shared<athena_utils::LifecycleNode>("move_base_node");
  auto node_cascade3 = std::make_shared<athena_utils::LifecycleNode>("tracking");
